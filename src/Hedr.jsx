...
import DeleteUser from "./UserData/DeleteUser"
      ...
      <DeleteUser/>
        ...
        <div className="h-full flex justify-center lg:flex-col  items-center">
          ...
          <div className="border-l border-[#494E6E] lg:border-t-[1px]  lg:border-l-0 lg:w-[103px]">
            <img src={localStorage.getItem('ras')} alt="" className="px-6 py-6 w-[103px] h-[103px] lg:mx-auto rounded-full lg:my-6" onClick={()=>dispach(Omborchi.actions.urd())}/>
          </div>
        </div>
    </div>
  )
