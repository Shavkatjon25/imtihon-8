...
function writeUserData(adres, city, postcode, country, name, email, cadres, ccity, ccountry, cpostcode, kun, muddat, pd, itm, k, dx) {
        ...
        <div className='mt-[25px] md:hidden'> 
            <p className='formp mb-[9px]'>Country</p>
                ...
                <div className='mt-[41px] mb-[25px] md:m-0'>
                    ...
                    <input type="date" disabled value={kun} onChange={e=>dispach(Omborchi.actions.kn(e.target.value))}   className={`w-full h-12 yz rbg px-5 outline-[#9277FF] border-[#DFE3FA] border-solid border-2 ${kun!='' || vl ? 'border-[#DFE3FA] outline-[#9277FF]' :'border-red-500 outline-red-500' }`}/>
             </div>
